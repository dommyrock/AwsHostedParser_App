              ...
              >
                <div itemscope="itemscope" itemtype="http://schema.org/JobPosting">
                  <div className={job_card_header}>
                    <ul
                      class="gc-action-group gc-h-und-list gc-card__actions"
                      style={{ float: "right" }}
                    >
                      <li class="gc-action-group__item">
                        <div class="gc-pop-over">
                          <button
                    ...
                    <h2 itemprop="title" className={job_card_title}>
                      Director, Cloud Business &amp; Systems Resilience Programs
                    </h2>{" "}
                  ...
                  <div className={pre_card_content}>
                    ...
                    >
                      <ul>
                        ...
                        <li>
                          20 years of experience with business continuity, disaster management
                          and/or response planning and implementation efforts
                        </li>
                        <li>
                          20 years of relevant experience managing multi-group, cross-functional
                          and/or cross-organizational projects
                        </li>
                        <li>
                          Experience with Google Drive and Google Workspace products (Sheets,
                          Slides, and Docs)
                        </li>
                      </ul>
                    </div>{" "}
                    <div class="gc-card__cta">
                      <a
                        href="/jobs/results/102432951100154566-director-cloud-business-systems-resilience-programs/"
